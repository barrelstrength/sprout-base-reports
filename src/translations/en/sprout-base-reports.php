...
return [
    ...
    'Visualizations allow you to configure your report to display a graphic on the results page.' => 'Visualizations allow you to configure your report to display a graphic on the results page.',
    'Visualizations allow you to configure your report to display a graphic on the results page. The settings for the Visualization Type you select below will help Sprout Reports know how to display the graphic.' => 'Visualizations allow you to configure your report to display a graphic on the results page. The settings for the Visualization Type you select below will help Sprout Reports know how to display the graphic.',
    'Selecting an Email Column will convert this report into a Mailing List. Column name is case sensitive and should match the exactly match the column name in the header of the report. Messages will only be sent to valid email addresses.' => 'Selecting an Email Column will convert this report into a Mailing List. Column name is case sensitive and should match the exactly match the column name in the header of the report. Messages will only be sent to valid email addresses.',
