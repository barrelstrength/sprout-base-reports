...
return [
    ...
    'Allow New?' => 'Allow New?',
    'Plugin' => 'Plugin',
    'Email Column Name <span class=\'info\'>The column name that represents a valid email address when used as a mailing list. Column name is not case sensitive.</span>' => 'Email Column Name <span class=\'info\'>The column name that represents a valid email address when used as a mailing list. Column name is not case sensitive.</span>',
    'Mailing List  <span class=\'info\'>Render HTML in your report results. Don\'t enable this setting if you allow user submitted content.</span>' => 'Mailing List  <span class=\'info\'>Render HTML in your report results. Don\'t enable this setting if you allow user submitted content.</span>',
    'Could not install Data Source.' => 'Could not install Data Source.',
    'Title Format <span class=\'info\'>Auto-generate your Segment name using settings values, such as {startDate|date(\'F d, Y\')}</span>' => 'Title Format <span class=\'info\'>Auto-generate your Segment name using settings values, such as {startDate|date(\'F d, Y\')}</span>',
    'New Segment' => 'New Segment',
    'Segments' => 'Segments',
    'Remove' => 'Remove',
    'Save Segment' => 'Save Segment',
    'Allow HTML <span class=\'info\'>Render HTML in your segment results. Don\'t enable this setting if you allow user submitted content.</span>' => 'Allow HTML <span class=\'info\'>Render HTML in your segment results. Don\'t enable this setting if you allow user submitted content.</span>',
    ...
    'All mailing list reports' => 'All mailing list reports',
    'Install' => 'Install',
    ...
    'Group' => 'Group',
    'Group <span class=\'info\'>The group where this segment should be displayed</span>' => 'Group <span class=\'info\'>The group where this segment should be displayed</span>',
    ...
    'View' => 'View',
    'A description of your segment that will appear in the info bubble next to your Segment Name on the Segments Index page.' => 'A description of your segment that will appear in the info bubble next to your Segment Name on the Segments Index page.',
    'Last 7 Days' => 'Last 7 Days',
    'Rename selected group' => 'Rename selected group',
    'What this segment will be called in the CP.' => 'What this segment will be called in the CP.',
    'Type' => 'Type',
    'Data Source deleted.' => 'Data Source deleted.',
    'Advanced Settings' => 'Advanced Settings',
    'Mailing List Settings' => 'Mailing List Settings',
    'Email Column <span class=\'info\'>The column name that represents a valid email address. Selecting an Email Column will convert this report into a Mailing List. Column name is not case sensitive.</span>' => 'Email Column <span class=\'info\'>The column name that represents a valid email address. Selecting an Email Column will convert this report into a Mailing List. Column name is not case sensitive.</span>'
];
